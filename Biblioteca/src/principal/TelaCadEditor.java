...
public class TelaCadEditor extends javax.swing.JFrame {
    private Connection conexaoBanco;

    public TelaCadEditor() {
        initComponents();
        personalizacoes();
    }
    
    public TelaCadEditor(Connection c) {
        this.conexaoBanco = c;
        initComponents();
        personalizacoes();
    }
    ...
    private void initComponents() {
        ...
        setTitle("SGB - Cadastramento de Editor");
        ...
        LabelTitulo.setText("Cadastramento de Editor");
        PainelTopo.add(LabelTitulo);
        LabelTitulo.setBounds(140, 20, 223, 22);
        ...
        if (n == JOptionPane.YES_OPTION) {
            try {
                if (txtNome.getText().equals("")) {
                    ...
                    Editor novoEditor = new Editor(0, txtNome.getText());
                    int ok = novoEditor.inclui(conexaoBanco);
                    if(ok > 0){
                        txtNome.setText("");
                        JOptionPane.showMessageDialog(null, "Editor Gravado com Sucesso!");
                    }
                    else{
                        throw new Exception("Erro na gravação do Editor");
                    }
                }
            } catch (Exception ee) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadEditor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadEditor().setVisible(true);
            }
        });
    }
