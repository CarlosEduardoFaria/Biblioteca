...
public class TelaListRevistas extends javax.swing.JFrame {
    private Connection conexaoBanco;
    
    public TelaListRevistas() {
        initComponents();
        personalizacoes();
    }
    
    public TelaListRevistas(Connection c) {
        this.conexaoBanco = c;
        initComponents();
        personalizacoes();
    }
    ...
    private void initComponents() {
        ...
        btnListarRevistas = new javax.swing.JButton();
        ...
        setTitle("SGB - Listagem de Revistas");
        ...
        LabelTitulo.setText("Listagem de Revistas");
        ...
        btnListarRevistas.setBackground(new java.awt.Color(51, 153, 255));
        btnListarRevistas.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnListarRevistas.setForeground(new java.awt.Color(255, 255, 255));
        btnListarRevistas.setText("Listar Todos");
        btnListarRevistas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnListarRevistasActionPerformed(evt);
            }
        });
        jPanelConteudo.add(btnListarRevistas);
        btnListarRevistas.setBounds(240, 20, 120, 23);
    ...
    private void btnListarRevistasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarRevistasActionPerformed
//        try{
//            dtArtigos.removeAll();
//            ArrayList<Revista> listaArtigos = Revista(conexaoBanco);
...
//        }
    }//GEN-LAST:event_btnListarRevistasActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListRevistas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListRevistas().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btnListarRevistas;
